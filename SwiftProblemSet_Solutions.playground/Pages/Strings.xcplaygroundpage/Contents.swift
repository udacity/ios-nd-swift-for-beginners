...
//Solution
var firstString = "You can write "
var secondString = "anything you want."
...
// Solution
let dollars = 567/100
let dollarsAndCentsString = "$\(dollars)." + "\(567 % 100)"
...
//Solution
var solutionString = "On average, millenials spend \(averageRent/averageMonthlyEarnings * 100)% of their income on rent."
//: [Next](@next)
